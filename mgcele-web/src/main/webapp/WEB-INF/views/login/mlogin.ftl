...
<head>
    ...
    <title>adv-会员登录</title>
    <script src="${base}/cdn/js/jquery-1.5.1.min.js"></script>
    ...
    <link rel="stylesheet" href="${base}/cdn/img/style.css" type="text/css" />
    <link rel="stylesheet" href="${base}/cdn/img/style2.css" type="text/css" />
</head>
<style type="text/css">
...
<form id="fm1" class="fm-v clearfix" action="member_login.do" method="post" onsubmit="return submitForm()">
    <div id="Logo">
        <div style="float:left"><div class="lg"><img width="165" src="${base}/cdn/img/logo.png" border="0" /></div><br/></div>
        <div class="nav"></div>
    ...
    <div id="Main">
        ...
        <div id="Login">
            <div class="top">
                <div class="left"><img src="${base}/cdn/img/login_conn_left.gif" width="4" height="4" /></div>
                <div class="right"><img src="${base}/cdn/img/login_conn_right.gif" width="4" height="4" /></div>
            </div>
            <div class="login_bg">
                <div>
                </div>
			...
			<font color="red"><b></b></font>
                ...
                <script>
                    if(GetCookie("adv_memberLoginName")!=null&&GetCookie("adv_memberLoginName")!=""){
                        document.getElementById("RememberMe").checked=true;
                    }
                    if(GetCookie("adv_memberLoginName")!=null)document.getElementById("username").value=GetCookie("adv_memberLoginName");
                    function RememberMeClick(){
                        if(document.getElementById("RememberMe").checked==false){
                            //删除cookie
                            DelCookie("adv_memberLoginName");
                        }
                    }
                    function submitForm(){
                        ...
                        if(document.getElementById("RememberMe").checked==true){
                            //设置cookie
                            SetCookie("adv_memberLoginName",document.getElementById("username").value,60*60*24*365);
                        }
                        return true;
                    }
                    $("#username").focus();
            ...
            <div class="bottom">
                <div class="left"><img src="${base}/cdn/img/login_conn_left_b.gif" width="4" height="4"  /></div>
                <div class="right"><img src="${base}/cdn/img/login_conn_right_b.gif" width="4" height="4" /></div>
            </div>
        </div>
        <div style="clear:both"></div>
    </div>
